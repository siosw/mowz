...
- PR titles formatted as `<area>: <change>`
- bumping the `Cargo.toml` version triggers a new release
...
- this project does not have users yet, do not worry about making breaking changes
